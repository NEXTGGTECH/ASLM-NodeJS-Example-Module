...
async function loadInfo() {
    ...
    setHtml("info-table", `
        <table class="kv-table">
            ...
            <tr><td>Node.js</td><td><code>${escHtml(data.nodeVersion || "")} — ${escHtml(data.nodeExecutable || "")}</code></td></tr>
...
async function startModules(moduleIds) {
    ...
    try {
        // Express proxies to ASLM POST /v1/modules/start.
